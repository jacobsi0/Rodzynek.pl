...
export const publicContent = {
  pl: {
    ...
    instagram: {
      ...
      subtitle:
        "Zobacz nasze najnowsze wpisy, kulisy warsztatów i relacje z konferencji na profilu @rodzynekedu.",
      handle: "@rodzynekedu",
      url: "https://www.instagram.com/rodzynekedu/",
      followButton: "Obserwuj @rodzynekedu",
      posts: [
        {
          url: "https://www.instagram.com/p/DY2OfVODHHS/",
          date: "27 maja",
          tag: "Konferencja UŁ",
          title: "Dumni z siebie nawzajem ❤️🩹 Konferencja na UŁ",
          excerpt:
            "To właśnie dziś przedstawiliśmy nasz projekt badawczy na konferencji międzynarodowej na Uniwersytecie Łódzkim. Wynieśliśmy mnóstwo nowej wiedzy i poznaliśmy inne projekty demokratyzujące głos młodzieży!",
          likes: "41",
          comments: "0",
          shares: "2",
          type: "Karuzela",
          media: {
            ...
            images: [
              "/instagram/karuzela-1.jpg",
              "/instagram/karuzela-2.jpg",
              "/instagram/karuzela-3.jpg",
              "/instagram/karuzela-4.jpg",
              "/instagram/karuzela-5.jpg",
              "/instagram/karuzela-6.jpg",
            ],
          },
        },
        {
          url: "https://www.instagram.com/p/DYzvoNrjLmV/",
          date: "26 maja",
          tag: "Zapowiedź",
          title: "Widzimy się na konferencji na Uniwersytecie Łódzkim 💙",
          excerpt:
            "Wydział Nauk o Wychowaniu UŁ. Będziemy mówić o Rodzynek.pl, naszych badaniach i o tym, dlaczego wsparcie rówieśnicze naprawdę ma znaczenie. Trzymajcie kciuki!",
          likes: "37",
          comments: "1",
          shares: "1",
          type: "Post",
          media: {
            type: "image" as const,
            image: "/instagram/post-zapowiedz.jpg",
          },
        },
        {
          url: "https://www.instagram.com/p/DYxkmtSjHav/",
          date: "25 maja",
          tag: "Warsztaty • XXXIV LO",
          title: "Pierwsze warsztaty „Masz głos” w LO nr 34 w Łodzi 🍇",
          excerpt:
            "Nie chcemy tworzyć warsztatów „dla młodzieży” bez młodzieży. Tworzymy je razem z Wami! Dziękujemy uczniom za otwartość, szczerość i wspaniałą rozmowę.",
          likes: "17",
          comments: "0",
          shares: "0",
          type: "Post",
          media: {
            type: "image" as const,
            image: "/instagram/post-warsztaty.jpg",
          },
        },
        {
          url: "https://www.instagram.com/p/DYma-XSCUUo/",
          date: "21 maja",
          tag: "O projekcie",
          title: "Rodzynek.pl: 4 przyjaciół, 1 rodzynek i masa historii 🍇",
          excerpt:
            "Ten projekt powstał z myślą o osobach, które choć raz czuły się „inne”, wykluczone lub samotne. Presja rówieśnicza potrafi siedzieć w głowie — rozmawiamy o tym po ludzku.",
          likes: "46",
          comments: "0",
          shares: "2",
          type: "Rolka",
          media: {
            type: "video" as const,
            video: "/instagram/reel-start.mp4",
          },
        },
      ],
    },
  ...
  en: {
    ...
    instagram: {
      ...
      subtitle:
        "Check out our latest posts, workshop recaps, and conference updates on @rodzynekedu.",
      handle: "@rodzynekedu",
      url: "https://www.instagram.com/rodzynekedu/",
      ...
      posts: [
        {
          url: "https://www.instagram.com/p/DY2OfVODHHS/",
          date: "May 27",
          tag: "Conference • Uni of Lodz",
          title: "Proud of each other ❤️🩹 International Conference at UŁ",
          excerpt:
            "Today we presented our research project at an international conference at the University of Lodz. We gained valuable knowledge and met amazing youth-led initiatives!",
          likes: "41",
          comments: "0",
          shares: "2",
          type: "Carousel",
        ...
        },
        {
          ...
          date: "May 26",
          tag: "Announcement",
          title: "See you at the University of Lodz conference tomorrow 💙",
          excerpt:
            "Faculty of Educational Sciences at UŁ. We will talk about Rodzynek.pl, our research, and why peer support truly makes a difference. Keep your fingers crossed!",
          likes: "37",
          comments: "1",
          shares: "1",
          type: "Post",
        ...
        },
        {
          url: "https://www.instagram.com/p/DYxkmtSjHav/",
          date: "May 25",
          tag: "Workshop • 34th High School",
          title: "First 'You have a voice' workshop at High School No. 34 🍇",
          excerpt:
            "We don't create workshops 'for youth' without youth. We create them together with students! Huge thanks to everyone for their openness and honest talks.",
          likes: "17",
          comments: "0",
          shares: "0",
          type: "Post",
        ...
        },
        {
          ...
          title: "Rodzynek.pl: 4 friends, 1 raisin, and lots of stories 🍇",
          excerpt:
            "This project was created for anyone who has ever felt excluded or alone with social pressure. We talk about it peer-to-peer, with empathy and zero preaching.",
          likes: "46",
          comments: "0",
          shares: "2",
          type: "Reel",
